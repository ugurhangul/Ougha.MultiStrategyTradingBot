...
class FakeoutStrategy(BaseStrategy):
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            # Load symbol parameters (needed for adaptive filter)
        ...
        try:
            ...
            for pos in existing_positions:
                if pos.position_type == PositionType.BUY:
                    # Extract strategy type from comment (format: "FB|15M_1M|BV")
                    ...
                    if comment_strategy == "FB" and comment_range == self.config.range_config.range_id:
                        self.logger.debug(
